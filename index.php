...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welcome to X - Bank</h4>
  ...
  <?php 
      ...
      if ($array->num_rows > 0)
      {
        ...
        echo "<div class='alert alert-info'>Empty Notification Box</div>";
     ?></p>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-2 rounded-1 shadowBlack" data-ride="carousel" >
          ...
          <div class="carousel-item active">
            <img class="d-block w-100" src="images/1.jpg" alt="First slide" style="min-height: 500px">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/3.jpg" alt="Third slide" style="min-height: 500px">
          </div>
...
<div class="col">
    <div class="row" style="padding: 22px;padding-top: 0">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/acount.jpg" style="max-height: 290px;min-height: 290px" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/transfer.jpg" alt="Card image cap" style="max-height: 290px;min-height: 290px">
        <div class="card-body">
    ...
    <div class="row" style="padding: 22px">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/bell.gif" style="max-height: 290px;min-height: 290px" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/contacts.gif" alt="Card image cap" style="max-height: 290px;min-height: 290px">
        <div class="card-body">
